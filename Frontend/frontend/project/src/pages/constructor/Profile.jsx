              ...
              <form onSubmit={handleProfileUpdate} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Tell clients about your construction experience and expertise..."
                  />
                </div>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g., Commercial Complex Construction"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  placeholder="Describe the project, your role, and construction highlights..."
                />
              </div>
